...
const sql = fs.readFileSync(path.join(__dirname, '../shared/migrations/26_super_offers_soft_delete.sql'), 'utf8');
...
async function run() {
  console.log('Applying Migration 26: Super offers soft delete...');
