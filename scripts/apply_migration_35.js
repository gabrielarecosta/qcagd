...
const sql = fs.readFileSync(path.join(__dirname, '../shared/migrations/35_create_category_rules_table.sql'), 'utf8');
...
async function run() {
  console.log('Applying Migration 35: Create category_rules table...');
