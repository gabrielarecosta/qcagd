...
async function run() {
  console.log("Fixing Ana García's order (PED-930274)...");
  
  const updatePayload = {
    estimated_delivery_shift: 'mañana',
    delivery_time_slot_id: 'slot-morning',
    delivery_start_time: '08:00',
    delivery_end_time: '12:00'
  };

  const res = await request('PATCH', 'orders?numero=eq.PED-930274', updatePayload);
